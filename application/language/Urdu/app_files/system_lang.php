...
$lang['allow_guardian_to_delete_chat'] = "سرپرست کو چیٹ حذف کرنے کی اجازت دیں";
$lang['allow_staff_to_delete_chat'] = "عملے کو چیٹ حذف کرنے کی اجازت دیں";
$lang['allow_student_to_add_partial_payment'] = "طالب علم کو جزوی ادائیگی شامل کرنے کی اجازت دیں";
$lang['allow_student_to_delete_chat'] = "طالب علم کو چیٹ حذف کرنے کی اجازت دیں";
$lang['allow_students_parents_and_staff_to_upload_student_document_through_google_drive'] = "طلباء، والدین اور عملے کو گوگل ڈرائیو کے ذریعے طالب علم کے دستاویزات اپلوڈ کرنے کی اجازت دیں";
$lang['api_key'] = "API کلید";
$lang['app_reference'] = "ایپ حوالہ";
$lang['balance_amount'] = "بقیہ رقم";
$lang['box_content_compact_wide'] = "باکس کا مواد (کمپیکٹ/وسیع)";
$lang['checked_by'] = "چیک کیا گیا بذریعہ";
$lang['class_teacher_signature'] = "کلاس ٹیچر کے دستخط";
$lang['class_with_same_section_already_taken'] = "اسی سیکشن کے ساتھ کلاس پہلے ہی لی جا چکی ہے";
$lang['company_token'] = "کمپنی ٹوکن";
$lang['delete_email_sms_log'] = "ای میل/ایس ایم ایس لاگ حذف کریں";
$lang['delete_logo_image'] = "لوگو تصویر حذف کریں";
$lang['delete_notice_board'] = "نوٹس بورڈ حذف کریں";
$lang['download_sample_csv_file'] = "نمونہ CSV فائل ڈاؤن لوڈ کریں";
$lang['download_tc'] = "TC ڈاؤن لوڈ کریں";
$lang['dpo_pay'] = "DPO ادائیگی";
$lang['dpopay'] = "DPO ادائیگی";
$lang['due_amount'] = "واجب الادا رقم";
$lang['due_fees_report'] = "واجب الادا فیس رپورٹ";
$lang['enable_multi_class_selection_in_student_admission_form'] = "طالب علم کے داخلہ فارم میں کثیر کلاس انتخاب فعال کریں";
$lang['enter_tc_no'] = "TC نمبر درج کریں";
$lang['enter_valid_amount_you_are_entering_more_than_required_amount'] = "صحیح رقم درج کریں (آپ مطلوبہ رقم سے زیادہ درج کر رہے ہیں)";
$lang['entity_id'] = "ادارہ ID";
$lang['exam_absent'] = "غائب";
$lang['fees_amount'] = "فیس کی رقم";
$lang['fill_other_details'] = "دیگر تفصیلات پُر کریں";
$lang['first_half'] = "پہلا نصف";
$lang['google_drive_setting'] = "گوگل ڈرائیو کی ترتیبات";
$lang['half_day_first_half'] = "نصف دن (پہلا نصف)";
$lang['header_footer_setting'] = "ہیڈر/فوٹر کی ترتیبات";
$lang['homework_marks_report'] = "ہوم ورک مارکس رپورٹ";
$lang['internal_error_occured'] = "اندرونی خرابی پیش آئی";
$lang['is_already_allotted_to_other_class_section_or_period_for_the_same_time'] = "پہلے ہی کسی اور کلاس/سیکشن یا وقت کے لیے مختص ہے";
$lang['kowri'] = "Kowri";
$lang['kowri_settings_not_available'] = "Kowri کی ترتیبات دستیاب نہیں ہیں";
$lang['leave_request_report'] = "رخصت کی درخواست کی رپورٹ";
$lang['momo_pay'] = "MOMO ادائیگی";
$lang['momopay'] = "MomoPay";
$lang['momopay_radio'] = "MomoPay";
$lang['momopay_settings_not_available'] = "MomoPay کی ترتیبات دستیاب نہیں ہیں";
$lang['multi_class'] = "کثیر کلاس";
$lang['my_leave_request_report'] = "میری رخصت کی درخواست کی رپورٹ";
$lang['no_changes_were_made'] = "کوئی تبدیلی نہیں کی گئی";
$lang['no_space_left_on_disk_please_check_your_disk_space_as_per_plan'] = "ڈسک میں کوئی جگہ باقی نہیں، براہ کرم اپنے پلان کے مطابق ڈسک اسپیس چیک کریں";
$lang['online_fees_deposit_through_kowri_txn_id'] = "Kowri TXN ID کے ذریعے آن لائن فیس جمع:";
$lang['online_fees_deposit_through_momopay_txn_id'] = "MomoPay TXN ID کے ذریعے آن لائن فیس جمع:";
$lang['other_setting'] = "دیگر ترتیبات";
$lang['partial_payment_disabled_note'] = "جزوی ادائیگی غیر فعال ہے۔ براہ کرم منتخب شدہ مکمل رقم ادا کریں";
$lang['pay_with'] = "کے ذریعے ادائیگی کریں";
$lang['pay_with_kowri'] = "Kowri کے ذریعے ادائیگی کریں";
$lang['pay_with_momopay'] = "MomoPay کے ذریعے ادائیگی کریں";
$lang['payment_gateway_for_zambia'] = "زمبیا کے لیے ادائیگی گیٹ وے";
$lang['payment_options_not_available'] = "ادائیگی کے اختیارات اس وقت دستیاب نہیں ہیں۔ براہ کرم بعد میں دوبارہ کوشش کریں";
$lang['please_enter_paying_amount'] = "براہ کرم ادا کرنے کی رقم درج کریں";
$lang['please_enter_valid_serial_number'] = "براہ کرم درست سیریل نمبر درج کریں";
$lang['please_select_payment_method'] = "براہ کرم جاری رکھنے کے لیے ادائیگی کا طریقہ منتخب کریں";
$lang['prepare_tc'] = "TC تیار کریں";
$lang['primary_color'] = "پرائمری رنگ";
$lang['principle_signature'] = "پرنسپل کے دستخط";
$lang['proceed_to_payment'] = "ادائیگی کے لیے آگے بڑھیں";
$lang['project_number_app_id'] = "پروجیکٹ نمبر / ایپ ID";
$lang['register'] = "رجسٹر کریں";
$lang['reissue'] = "دوبارہ جاری کریں";
$lang['second_half'] = "دوسرا نصف";
$lang['secret'] = "خفیہ";
$lang['select_payment_method'] = "ادائیگی کا طریقہ منتخب کریں";
$lang['side_menu_navigation'] = "سائیڈ مینو (نیویگیشن)";
$lang['skins_shadow_bordered'] = "تھیمز (سایہ/بارڈر)";
$lang['sms_gateway_hub'] = "SMS گیٹ وے ہب";
$lang['start_next_from'] = "شروع کریں / اگلے سے";
$lang['student_logout_and_disable'] = "طالب علم لاگ آؤٹ اور غیر فعال کریں";
$lang['subscription_key'] = "سبسکرپشن کلید";
$lang['tc_no'] = "TC نمبر";
$lang['tc_settings'] = "TC کی ترتیبات";
$lang['the_sms_settings_are_not_configured_correctly'] = "SMS کی ترتیبات درست طریقے سے مرتب نہیں ہیں";
$lang['the_student_is_enrolled_in_a_multi_class_please_navigate_to_the_multi_class_student_and_remove_the_student_from_there'] = "طالب علم کثیر کلاس میں داخل ہے۔ براہ کرم کثیر کلاس اسٹوڈنٹ میں جائیں اور طالب علم کو وہاں سے ہٹا دیں";
$lang['theme_mode_light_dark'] = "تھیم موڈ (ہلکا/گہرا)";
$lang['this_student_is_enrolled_in_a_multi_class_please_go_to_the_student_information_multi_class_student_and_remove_the_student_from_there'] = "یہ طالب علم کثیر کلاس میں داخل ہے۔ براہ کرم طالب علم کی معلومات > کثیر کلاس اسٹوڈنٹ میں جائیں اور طالب علم کو وہاں سے ہٹا دیں";
$lang['total_due_amount'] = "کل واجب الادا رقم";
$lang['total_pay_fees'] = "کل فیس ادا کریں";
$lang['total_pay_fine'] = "کل جرمانہ ادا کریں";
$lang['transfer_certificate'] = "ٹرانسفر سرٹیفکیٹ";
$lang['transfer_certificate_fields'] = "ٹرانسفر سرٹیفکیٹ کے فیلڈز";
$lang['transfer_certificate_serial_number'] = "ٹرانسفر سرٹیفکیٹ سیریل نمبر";
$lang['transfer_certificate_settings'] = "ٹرانسفر سرٹیفکیٹ کی ترتیبات";
$lang['upload_through_google_drive'] = "گوگل ڈرائیو کے ذریعے اپلوڈ کریں";
$lang['user_id'] = "یوزر ID";
$lang['verify_tc'] = "TC کی تصدیق کریں";
$lang["you_cant_save_fine_amount_only"] = "آپ صرف جرمانہ کی رقم محفوظ نہیں کر سکتے";
$lang["affiliation_no"] = "الحاق نمبر";