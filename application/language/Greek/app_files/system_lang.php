...
$lang['allow_guardian_to_delete_chat'] = "Επιτρέψτε στον κηδεμόνα να διαγράψει τη συνομιλία";
$lang['allow_staff_to_delete_chat'] = "Επιτρέψτε στο προσωπικό να διαγράψει τη συνομιλία";
$lang['allow_student_to_add_partial_payment'] = "Επιτρέψτε στον μαθητή να προσθέσει μερική πληρωμή";
$lang['allow_student_to_delete_chat'] = "Επιτρέψτε στον μαθητή να διαγράψει τη συνομιλία";
$lang['allow_students_parents_and_staff_to_upload_student_document_through_google_drive'] = "Επιτρέψτε σε μαθητές, γονείς και προσωπικό να ανεβάζουν έγγραφα μαθητών μέσω Google Drive";
$lang['api_key'] = "Κλειδί API";
$lang['app_reference'] = "Αναφορά Εφαρμογής";
$lang['balance_amount'] = "Υπόλοιπο";
$lang['box_content_compact_wide'] = "Περιεχόμενο Κουτιού (Συμπαγές/Ευρύ)";
$lang['checked_by'] = "Ελεγμένο από";
$lang['class_teacher_signature'] = "Υπογραφή Δασκάλου Τάξης";
$lang['class_with_same_section_already_taken'] = "Η τάξη με την ίδια ενότητα έχει ήδη καταχωρηθεί";
$lang['company_token'] = "Κωδικός Εταιρείας";
$lang['delete_email_sms_log'] = "Διαγραφή Αρχείου Email/SMS";
$lang['delete_logo_image'] = "Διαγραφή Εικόνας Λογότυπου";
$lang['delete_notice_board'] = "Διαγραφή Πίνακα Ανακοινώσεων";
$lang['download_sample_csv_file'] = "Λήψη Δείγματος Αρχείου CSV";
$lang['download_tc'] = "Λήψη TC";
$lang['dpo_pay'] = "Πληρωμή DPO";
$lang['dpopay'] = "Πληρωμή DPO";
$lang['due_amount'] = "Οφειλόμενο Ποσό";
$lang['due_fees_report'] = "Αναφορά Οφειλόμενων Τελών";
$lang['enable_multi_class_selection_in_student_admission_form'] = "Ενεργοποίηση επιλογής πολλαπλών τάξεων στη φόρμα εισαγωγής μαθητή";
$lang['enter_tc_no'] = "Εισαγάγετε Αριθμό TC";
$lang['enter_valid_amount_you_are_entering_more_than_required_amount'] = "Εισάγετε έγκυρο ποσό (εισάγετε μεγαλύτερο από το απαιτούμενο)";
$lang['entity_id'] = "ID Οντότητας";
$lang['exam_absent'] = "Απουσία";
$lang['fees_amount'] = "Ποσό Τελών";
$lang['fill_other_details'] = "Συμπληρώστε Λοιπές Λεπτομέρειες";
$lang['first_half'] = "Πρώτο Ημίχρονο";
$lang['google_drive_setting'] = "Ρυθμίσεις Google Drive";
$lang['half_day_first_half'] = "Μισή Ημέρα (Πρώτο Ημίχρονο)";
$lang['header_footer_setting'] = "Ρυθμίσεις Κεφαλίδας/Υποσέλιδου";
$lang['homework_marks_report'] = "Αναφορά Βαθμών Εργασιών";
$lang['internal_error_occured'] = "Παρουσιάστηκε εσωτερικό σφάλμα";
$lang['is_already_allotted_to_other_class_section_or_period_for_the_same_time'] = "έχει ήδη καταχωρηθεί σε άλλη τάξη/ενότητα ή περίοδο την ίδια ώρα";
$lang['kowri'] = "Kowri";
$lang['kowri_settings_not_available'] = "Οι ρυθμίσεις Kowri δεν είναι διαθέσιμες";
$lang['leave_request_report'] = "Αναφορά Αιτήματος Αδείας";
$lang['momo_pay'] = "Πληρωμή MOMO";
$lang['momopay'] = "MomoPay";
$lang['momopay_radio'] = "MomoPay";
$lang['momopay_settings_not_available'] = "Οι ρυθμίσεις MomoPay δεν είναι διαθέσιμες";
$lang['multi_class'] = "Πολλαπλές Τάξεις";
$lang['my_leave_request_report'] = "Η Αναφορά Αιτήματος Αδείας Μου";
$lang['no_changes_were_made'] = "Δεν έγιναν αλλαγές";
$lang['no_space_left_on_disk_please_check_your_disk_space_as_per_plan'] = "Δεν υπάρχει διαθέσιμος χώρος στο δίσκο, ελέγξτε τον χώρο σύμφωνα με το σχέδιο.";
$lang['online_fees_deposit_through_kowri_txn_id'] = "Κατάθεση τελών online μέσω Kowri TXN ID:";
$lang['online_fees_deposit_through_momopay_txn_id'] = "Κατάθεση τελών online μέσω MomoPay TXN ID:";
$lang['other_setting'] = "Άλλη Ρύθμιση";
$lang['partial_payment_disabled_note'] = "Η μερική πληρωμή είναι απενεργοποιημένη. Παρακαλώ πληρώστε ολόκληρο το επιλεγμένο ποσό.";
$lang['pay_with'] = "Πληρωμή με";
$lang['pay_with_kowri'] = "Πληρωμή με Kowri";
$lang['pay_with_momopay'] = "Πληρωμή με MomoPay";
$lang['payment_gateway_for_zambia'] = "Πύλη Πληρωμών για τη Ζάμπια";
$lang['payment_options_not_available'] = "Οι επιλογές πληρωμής δεν είναι διαθέσιμες προς το παρόν. Παρακαλώ δοκιμάστε ξανά αργότερα.";
$lang['please_enter_paying_amount'] = "Εισαγάγετε το Ποσό Πληρωμής";
$lang['please_enter_valid_serial_number'] = "Εισαγάγετε Έγκυρο Σειριακό Αριθμό";
$lang['please_select_payment_method'] = "Επιλέξτε μέθοδο πληρωμής για να συνεχίσετε.";
$lang['prepare_tc'] = "Προετοιμασία TC";
$lang['primary_color'] = "Κύριο Χρώμα";
$lang['principle_signature'] = "Υπογραφή Διευθυντή";
$lang['proceed_to_payment'] = "Συνέχεια στην Πληρωμή";
$lang['project_number_app_id'] = "Αριθμός Έργου/ID Εφαρμογής";
$lang['register'] = "Εγγραφή";
$lang['reissue'] = "Επανέκδοση";
$lang['second_half'] = "Δεύτερο Ημίχρονο";
$lang['secret'] = "Μυστικό";
$lang['select_payment_method'] = "Επιλέξτε Μέθοδο Πληρωμής";
$lang['side_menu_navigation'] = "Πλευρικό Μενού (Πλοήγηση)";
$lang['skins_shadow_bordered'] = "Θέματα (Σκιά/Περίγραμμα)";
$lang['sms_gateway_hub'] = "Κέντρο Πύλης SMS";
$lang['start_next_from'] = "Έναρξη / Επόμενο από";
$lang['student_logout_and_disable'] = "Αποσύνδεση και Απενεργοποίηση Μαθητή";
$lang['subscription_key'] = "Κλειδί Συνδρομής";
$lang['tc_no'] = "Αρ. TC";
$lang['tc_settings'] = "Ρυθμίσεις TC";
$lang['the_sms_settings_are_not_configured_correctly'] = "Οι ρυθμίσεις SMS δεν έχουν διαμορφωθεί σωστά.";
$lang['the_student_is_enrolled_in_a_multi_class_please_navigate_to_the_multi_class_student_and_remove_the_student_from_there'] = "Ο μαθητής είναι εγγεγραμμένος σε πολλαπλές τάξεις. Μεταβείτε στον Multi-Class Student και αφαιρέστε τον μαθητή από εκεί.";
$lang['theme_mode_light_dark'] = "Λειτουργία Θέματος (Φωτεινό/Σκοτεινό)";
$lang['this_student_is_enrolled_in_a_multi_class_please_go_to_the_student_information_multi_class_student_and_remove_the_student_from_there'] = "Αυτός ο μαθητής είναι εγγεγραμμένος σε πολλαπλές τάξεις. Μεταβείτε στις Πληροφορίες Μαθητή > Multi-Class Student και αφαιρέστε τον μαθητή από εκεί.";
$lang['total_due_amount'] = "Συνολικό Οφειλόμενο Ποσό";
$lang['total_pay_fees'] = "Συνολικές Πληρωτέες Τέλη";
$lang['total_pay_fine'] = "Συνολική Πληρωμή Προστίμου";
$lang['transfer_certificate'] = "Πιστοποιητικό Μεταφοράς";
$lang['transfer_certificate_fields'] = "Πεδία Πιστοποιητικού Μεταφοράς";
$lang['transfer_certificate_serial_number'] = "Σειριακός Αριθμός Πιστοποιητικού Μεταφοράς";
$lang['transfer_certificate_settings'] = "Ρυθμίσεις Πιστοποιητικού Μεταφοράς";
$lang['upload_through_google_drive'] = "Ανέβασμα μέσω Google Drive";
$lang['user_id'] = "ID Χρήστη";
$lang['verify_tc'] = "Επαλήθευση TC";
$lang["you_cant_save_fine_amount_only"] = "Δεν μπορείτε να αποθηκεύσετε μόνο το ποσό του προστίμου";
$lang["affiliation_no"] = "Αριθμός Σύνδεσης";
