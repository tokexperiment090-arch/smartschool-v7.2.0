                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="table-responsive overflow-visible"><div class="download_label"><?php echo $this->lang->line('sms_template_list'); ?></div>
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('sms_template_list');?>">
                                <thead>
                                    <tr>
...
foreach ($sms_template_list as $key => $sms_template_list_value) {?>
                                        <tr>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('sms_template', 'can_edit')) {?>
                                                <a class="btn btn-primary btn-xs editsmstemplate" data-id="<?php echo $sms_template_list_value['id'] ?>"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i>
                                                </a>
                                            <?php }?>
                                            <?php if ($this->rbac->hasPrivilege('sms_template', 'can_delete')) {?>
                                                <a href="<?php echo base_url(); ?>admin/mailsms/delete_sms_template/<?php echo $sms_template_list_value['id'] ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');"><i class="fa fa-remove"></i>
                                                </a>
                                            <?php }?>
                                            </td>
                                        </tr>
