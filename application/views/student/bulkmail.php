    ...
    ?>
                                    ...
                                    <div class="table-responsive">
                                        <div class="download_label"><?php echo $this->lang->line('bulk_mail') ?></div>
                                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%"  data-export-title="<?php echo $this->lang->line('login_credentials_send');?>">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
