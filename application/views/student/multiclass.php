...
echo $this->customlib->getFullName($student_value['firstname'], $student_value['middlename'], $student_value['lastname'], $sch_setting->middlename, $sch_setting->lastname) . " (" . $student_value['admission_no'] . ")";
        ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="col-xs-12 col-xs-offset-0 col-sm-3 col-sm-offset-9">
                                                                ...
                                                                <button type="button" class="btn btn-primary btn-sm pull-right addrow addrow-mb2010">
                                                    ...
                                                    <div class="append_row pluscolmn pe-5">
                                                ...
                                                <div class="panel-footer panel-fo">
                                                    <div class="row text-center">
                                                        ...
                                                        <div class="col-xs-12 col-xs-offset-0 col-sm-3 col-sm-offset-9">
                                                            ...
                                                            <button type="submit" class="btn btn-primary btn-sm pull-right" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('update'); ?>">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.addrow', function () {
        ...
        var $newDiv = $('<div>').addClass('row').append(
                ...
                $('<div>').addClass('col-sm-4 col-lg-4 col-md-4').append($('<div>').addClass('form-group').append($('<label>').html('<?php echo $this->lang->line("section"); ?>')).append(new_section_dropdown))
                ).append(
                $('<div>').addClass('col-sm-3 col-lg-3 col-md-4').append($('<div>').addClass('form-group').append($('<label>',{ css: {'opacity': 0}}).html('Action')).append(
