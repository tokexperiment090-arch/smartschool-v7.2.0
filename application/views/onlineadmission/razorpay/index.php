                            ...
                            <form action="#" method="post">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <button type="button" id="pay_btn" onclick="pay()" name="search"  value="" class="btn btn-info pull-right submit_button"> <?php echo $this->lang->line('pay_with_razorpay'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
