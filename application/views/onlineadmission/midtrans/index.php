                                ...
                                <form id="checkoutform" action="#" method="post">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"><button type="button"  name="search" id="pay-button" value="" class="btn btn-info pull-right submit_button"> <?php echo $this->lang->line('pay_with_midtrans'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
