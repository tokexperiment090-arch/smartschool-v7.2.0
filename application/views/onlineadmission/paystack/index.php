                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/paystack/pay" method="post">
                                <table class="table2" width="100%">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td class="text-right"> <button type="submit" name="search" value="" class="btn pull-right submit_button"><?php echo $this->lang->line('pay_with_paystack'); ?> <i class="fa fa fa-chevron-right"></i></button> </td>
                                    </tr>
                                </table>
