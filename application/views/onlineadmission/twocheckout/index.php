                            ...
                            <form action="#" method="post" name="pay_now">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td class="text-right"> <button type="button"  id="buy-button" name="search"  value="" class="btn btn-info pull-right submit_button"> <?php echo $this->lang->line('pay_with_twocheckout'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
