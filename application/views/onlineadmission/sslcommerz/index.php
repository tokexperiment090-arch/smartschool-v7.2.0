                        ...
                        <div class="paymentbg">
                            ...
                            ?></td>
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td class="text-right"><button type="submit"  name="search"  value="" class="btn btn-info pull-right submit_button"><?php echo $this->lang->line("pay_with_sslcommerz"); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                    </tr>
                                </table>
                            </form>
                            </div>
