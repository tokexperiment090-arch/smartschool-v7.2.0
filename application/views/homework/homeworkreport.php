                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive overflow-visible">
                            <div class="download_label"><?php echo $this->lang->line('homework_report') ;
                                        ?></div>
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('homework_report');?>">
                                <thead>
                                            <tr>
                                                ...
                                                <th width="5%" class="dt-body-left dt-head-left"><?php echo $this->lang->line('student_count'); ?></th>
                                                <th width="5%" class="dt-body-left dt-head-left"><?php echo $this->lang->line('homework_submitted'); ?></th>
                                                <th width="5%" class="dt-body-left dt-head-left"><?php echo $this->lang->line('pending_student'); ?></th>                                                 
                                            </tr>
                                        </thead>
                                <tbody>
                                     <?php
                                        ...
                                        foreach ($resultlist as $student) {                                           
                                            ...
                                            <tr>
                                                ...
                                                <td class="dt-body-left dt-head-left">
                                                    <a  id="load" data-toggle="tooltip"  data-clss-id="<?php echo $student['class_id']; ?>" data-section-id="<?php echo $student['section_id']; ?>" data-homework-id="<?php echo $student['id']; ?>" data-type="student_count" ><?php echo $student['student_count']; ?></a>    
                                                </td>                                                
                                                <td class="dt-body-left dt-head-left"> 
                                                    <a  id="load" data-toggle="tooltip"  data-clss-id="<?php echo $student['class_id']; ?>" data-section-id="<?php echo $student['section_id']; ?>" data-homework-id="<?php echo $student['id']; ?>" data-type="homework_submitted" ><?php echo $student['assignments']; ?></a>
                                                </td>                                                
                                                <td class="dt-body-left dt-head-left">
                                                    <a  id="load" data-toggle="tooltip" data-clss-id="<?php echo $student['class_id']; ?>" data-section-id="<?php echo $student['section_id']; ?>" data-homework-id="<?php echo $student['id']; ?>" data-type="pending_student" ><?php echo $student['student_count']-$student['assignments']; ?></a>                                         
                                                </td>                                                   
                                            </tr>
                                            <?php
                                            $count++;
